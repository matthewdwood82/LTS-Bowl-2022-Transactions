...
```{r install_packages}
renv::install(c("dplyr", "purrr", "stringr", "lubridate", "googlesheets4", "ffscrapr", "rlang"))

```

## Load Packages

Make some calls to `library()` to load the packages you just installed. This is the R equivelant of Python's `import`.
